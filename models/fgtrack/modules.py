...
from lib.models.fgtrack.resnet import resnet18
from lib.models.fgtrack.cbam import CBAM
...
class ResBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        # r = self.conv1(F.relu(x.view(1, 768, 24,24)))
...
class HistoricalPromptEncoder(nn.Module):
    def __init__(self):
        ...
        self.fuser = FeatureFusionBlock(768 + 256, 768)
