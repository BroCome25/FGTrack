...
class VisionTransformerCE(VisionTransformer):
    ...
    def forward_features(self, z, x, mask_z=None, mask_x=None,
        ...
        aux_dict = {
            ...
            "global_index_s": global_index_s  # 保留的token重新排序的顺序
        }
    ...
    def forward(self, z, x, ce_template_mask=None, ce_keep_rate=None,
        ...
        x, aux_dict = self.forward_features(z, x, ce_template_mask=ce_template_mask, ce_keep_rate=ce_keep_rate, previous_anno=previous_anno, previous_frames=previous_frames)
