...
class Transformer_dec(nn.Module):
    ...
    def __init__(self, d_model=384, nhead=8, num_encoder_layers=6,
    ...
    def forward(self, feat, tgt, feat_len_s, pos, query_embed):#feat:(256,B,768)
...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward_post(self, tgt_all, memory,
        ...
        #print(len(tgt_all))
        tgt_q = tgt_all[0] #(1,B,768)
        tgt_kv = tgt_all[1] #(1,B,768)
        q = tgt_q #(1,B,768)
        k = tgt = tgt_kv #(1,B,768)
