...
if __name__ == "__main__":
    ...
    parser.add_argument('--tracker_name', type=str,default='fgtrack',help='Name of tracking method.')
    parser.add_argument('--cfg_name', type=str,default='fgtrack_got_384', help='Name of config file.')
