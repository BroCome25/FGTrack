...
def main():
    ...
    parser.add_argument('--script', type=str, default="fgtrack", help='Name of the train script.')
    parser.add_argument('--config', type=str, default='fgtrack_got_384', help="Name of the config file.")
