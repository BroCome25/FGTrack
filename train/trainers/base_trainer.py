        ...
        for i in range(num_tries):
            try:
                ...
                for epoch in range(self.epoch+1, max_epochs+1):
                    ...
                    save_epochs = [0, 1, 2, 3, 79, 159, 239]
                    # if epoch > (max_epochs - 1) or save_every_epoch or epoch in save_epochs or epoch > (max_epochs - 5):
                    if epoch > (max_epochs - 1) or epoch in save_epochs or epoch > (max_epochs - 5):
